...
5. **Первая линия клиентской поддержки:** Регламент обработки обращений от покупателей (где мой заказ, правила возврата, отмены). Согласование выделения ресурса на стороне TI (чат/телефон).
